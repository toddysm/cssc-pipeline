...
skopeo copy --format=oci docker://toddysm/flasksample:kubeconeu-demo-v1 docker://ghcr.io/toddysm/flasksample:signing-demo-v1
skopeo copy --format=oci docker://toddysm/net-monitor:kubeconeu-demo-v1 docker://ghcr.io/toddysm/net-monitor:signing-demo-v1
...
$ export APPLICATION_IMAGE='ghcr.io/toddysm/flasksample:signing-demo-v1'
$ export TEST_IMAGE='ghcr.io/toddysm/net-monitor:signing-demo-v1''
